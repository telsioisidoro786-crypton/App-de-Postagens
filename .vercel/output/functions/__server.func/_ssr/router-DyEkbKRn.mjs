...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DyEkbKRn.js
...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Estúdio de posts para redes sociais — tipografia, formatos, imagens e modelos."
			},
			{
				name: "theme-color",
				content: "#0c0b0a"
...
var $$splitComponentImporter = () => import("./routes-Qpg-0BIk.mjs");
...
//#endregion
export { getFont as i, FONTS as n, GOOGLE_FONTS_HREF as r, router_exports as t };
